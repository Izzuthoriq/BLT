    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $id = 0;
                foreach ($petugas_lapangan_data as $i) :
                    $id++;
                    $id_user = $i['id_user'];
                    $username = $i['username'];
                    $password = $i['password'];
                ...
                ?>
                    <form action="<?= base_url(); ?>Settings/lengkapi_data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" aria-describedby="nama_lengkap" value="<?= $nama_lengkap ?>" required>
                        </div>
                        <div class="form-group">
