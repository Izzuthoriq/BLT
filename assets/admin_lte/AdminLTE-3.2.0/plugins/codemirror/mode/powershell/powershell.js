...
(function (mod) {
  ...
  CodeMirror.defineMode("powershell", function () {
      ...
      [
        ...
        new RegExp(
          "Get-(Acl|Alias|AuthenticodeSignature|ChildItem|Command|ComputerRestorePoint|Content|ControlPanelItem|Counter|Credential" +
            "|Culture|Date|Event|EventLog|EventSubscriber|ExebltonPolicy|FormatData|Help|History|Host|HotFix|Item|ItemProperty|Job" +
        ...
        /Send-MailMessage/,
        new RegExp(
          "Set-(Acl|Alias|AuthenticodeSignature|Content|Date|ExebltonPolicy|Item(Property)?|Location|PSBreakpoint|PSDebug" +
    ...
    var variableBuiltins = buildRegexp(
      [
        /[$?^_]|Args|ConfirmPreference|ConsoleFileName|DebugPreference|Error|ErrorActionPreference|ErrorView|ExebltonContext/,
