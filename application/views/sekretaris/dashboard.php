                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?= base_url(); ?>blt/view_sekretaris" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p>Data Warga Menuggu Konfirmasi</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?= $petugas_lapangan['total_user'] ?></h3>
                                ...
                                <a href="<?= base_url(); ?>petugas_lapangan/view_sekretaris" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-primary">
                                ...
                                <a href="<?= base_url(); ?>Admin/view_sekretaris" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
