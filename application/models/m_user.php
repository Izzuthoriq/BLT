...
class M_user extends CI_Model
{
    ...
    public function get_all_petugas_lapangan()
    {
    ...
    public function count_all_petugas_lapangan()
    {
    ...
    public function get_petugas_lapangan_by_id($id_user)
    {
        $hasil = $this->db->query("SELECT * FROM user JOIN user_detail ON user.id_user_detail = user_detail.id_user_detail 
    ...
    public function insert_petugas_lapangan($id, $username, $email, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $alamat)
    {
        $this->db->trans_start();
    ...
    public function update_petugas_lapangan($id, $username, $email, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $alamat)
    {
        $this->db->trans_start();
    ...
    public function delete_petugas_lapangan($id)
    {
        $this->db->trans_start();
