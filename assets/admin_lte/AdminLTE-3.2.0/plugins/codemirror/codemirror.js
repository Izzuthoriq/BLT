...
(function (global, factory) {
  ...
  function endOfLine(visually, cm, lineObj, lineNo, dir) {
    if (visually) {
      ...
      if (order) {
        ...
        // since visual lines contain content order-consebltve chunks.
  ...
  function CodeMirror(place, options) {
    ...
    this.state = {
      ...
      pasteIncoming: -1,
      bltncoming: -1, // help recognize paste/cut edits in input.poll
      selectingText: false,
      draggingText: false,
  ...
  function applyTextInput(cm, inserted, deleted, sel, origin) {
    ...
    for (var i$1 = sel.ranges.length - 1; i$1 >= 0; i$1--) {
      ...
      var changeEvent = {
        ...
        origin:
          origin ||
          (paste ? "paste" : cm.state.bltncoming > recent ? "cut" : "+input"),
      };
    ...
    cm.state.pasteIncoming = cm.state.bltncoming = -1;
  }
